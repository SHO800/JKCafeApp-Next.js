...
export const OrderHooksWrapper = memo(function ({children, menus, sendOrderData}:{children: ReactNode, menus: MenuData, sendOrderData:(orderDetails: OrderDetail[]) => void})  {
